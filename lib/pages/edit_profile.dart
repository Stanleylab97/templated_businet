...
class _EditProfileState extends State<EditProfile> {
  ...
  handleUpdateData () async {
    ...
    if (ib.hasInternet == false) {
      openSnacbar(scaffoldKey, 'Pas de connexion internet'.tr());
    } else {
      ...
      ? await sb.updateUserProfile(nameCtrl.text, imageUrl)
        .then((value){
          openSnacbar(scaffoldKey, 'Mise à jour  réussie'.tr());
      ...
      : await uploadPicture()
        .then((value) => sb.updateUserProfile(nameCtrl.text, imageUrl).then((_) {
          openSnacbar(scaffoldKey, 'Mise à jour successfully'.tr());
          setState(()=> loading = false );
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
        title: Text('Edtion du profil').tr(),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                child: loading == true 
                  ...
                  : Text('Mise à jour du profil', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),).tr(),
                onPressed: (){
                  handleUpdateData();
                },
