              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  validator: (String value){
                    if (value.length == 0) return "Le nom ne peut pas rester vide";
                    return null;
                  },
                ...
                TextFormField(
                  ...
                  validator: (String value){
                    if (value.length == 0) return "L'adresse Email ne peut rester vide";
                    return null;
                  },
                  onChanged: (String value){
                    setState(() {
                ...
                TextFormField(
                  ...
                  validator: (String value){
                    if (value.length == 0) return "Le mot de passe ne peut rester vide";
                    return null;
                  },
                  onChanged: (String value){
                    setState(() {
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: signUpStarted == false 
                      ? Text('Inscription', style: TextStyle(fontSize: 16, color: Colors.white),).tr()
                      : signUpCompleted == false 
                      ? CircularProgressIndicator(backgroundColor: Colors.white)
                      : Text('Inscription réussie !', style: TextStyle(fontSize: 16, color: Colors.white)).tr(),
                    onPressed: (){
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    TextButton(
                      child: Text('Se connecter', style: TextStyle(color: Theme.of(context).primaryColor),).tr(),
                      onPressed: (){
                        if(widget.tag == null){
