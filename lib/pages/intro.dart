...
class _IntroPageState extends State<IntroPage> {
  ...
  Widget build(BuildContext context) {
    return IntroductionScreen(
      ...
      showSkipButton: true,
      skip: const Text('Sauter', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey)).tr(),
      next: const Icon(Icons.navigate_next),
      done: const Text("Effectué", style: TextStyle(fontWeight: FontWeight.w600)).tr(),
