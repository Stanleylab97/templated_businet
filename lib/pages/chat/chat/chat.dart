...
import 'package:news_app/config/common/loading.dart';
import 'package:news_app/models/chat/chat_params.dart';
import 'package:news_app/models/chat/message.dart';
import 'package:news_app/pages/chat/services/message_database.dart';

import 'message_item.dart';

class Chat extends StatefulWidget {
  const Chat({Key key,  this.chatParams}) : super(key: key);
