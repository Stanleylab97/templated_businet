import 'package:news_app/models/posts/user.dart';
...
const posts = <Post>[
  Post(
    user: User(name: 'Diego Velasquez', photo: 'assets/images/linkedin/users/diego.jpg'),
    isLikeMe: true,
    like: 350,
    ...
    timeAgo: '3 days ago',
    comment: 480,
    photo: 'assets/images/linkedin/posts/post_diego.jpg',
  ),
  Post(
    user: User(name: 'Brangy Castro', photo: 'assets/images/linkedin/users/brangy.jpg'),
    isLikeMe: true,
    like: 48,
    timeAgo: '10 days ago',
    comment: 600,
    title: 'Security Informatic.',
    photo: 'assets/images/linkedin/posts/brangy_post.jpg',
    description:
  ...
  Post(
      user: User(name: 'Javier Velez', photo: 'assets/images/linkedin/users/javier.jpg'),
      like: 85,
      photo: 'assets/images/linkedin/posts/javier_post.jpg',
      comment: 200,
      timeAgo: '22 days ago',
  ...
  Post(
      user: User(name: 'Mauricio Lopez', photo: 'assets/images/linkedin/users/mao.jpg'),
      like: 130,
      photo: 'assets/images/linkedin/posts/mao_post.jpg',
      comment: 350,
      timeAgo: '3 week ago',
      title: 'Creating logo',
      description:
